...
namespace Relations.Migrations
{
    ...
    [Migration("20241216190421_final_state")]
    partial class final_state
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Relations.Models.PostTag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            tagId = "25",
                            postId = "9",
                            AddedOn = new DateTime(2024, 12, 16, 21, 4, 21, 755, DateTimeKind.Local).AddTicks(395)
                        },
                        new
                        {
                            tagId = "2",
                            postId = "9",
                            AddedOn = new DateTime(2024, 12, 16, 21, 4, 21, 755, DateTimeKind.Local).AddTicks(459)
                        },
                        new
                        {
                            tagId = "25",
                            postId = "2",
                            AddedOn = new DateTime(2024, 12, 16, 21, 4, 21, 755, DateTimeKind.Local).AddTicks(463)
                        });
                });
