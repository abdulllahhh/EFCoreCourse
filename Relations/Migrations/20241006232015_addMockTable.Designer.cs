...
namespace Relations.Migrations
{
    ...
    [Migration("20241006232015_addMockTable")]
    partial class addMockTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Relations.PostTag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            tagId = "25",
                            postId = "9",
                            AddedOn = new DateTime(2024, 10, 7, 2, 20, 15, 347, DateTimeKind.Local).AddTicks(836)
                        },
                        new
                        {
                            tagId = "2",
                            postId = "9",
                            AddedOn = new DateTime(2024, 10, 7, 2, 20, 15, 347, DateTimeKind.Local).AddTicks(904)
                        },
                        new
                        {
                            tagId = "25",
                            postId = "2",
                            AddedOn = new DateTime(2024, 10, 7, 2, 20, 15, 347, DateTimeKind.Local).AddTicks(907)
                        });
                });
