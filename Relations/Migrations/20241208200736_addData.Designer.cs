...
namespace Relations.Migrations
{
    ...
    [Migration("20241208200736_addData")]
            ...
            modelBuilder.Entity("Relations.PostTag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            tagId = "25",
                            postId = "9",
                            AddedOn = new DateTime(2024, 12, 8, 22, 7, 35, 496, DateTimeKind.Local).AddTicks(6034)
                        },
                        new
                        {
                            tagId = "2",
                            postId = "9",
                            AddedOn = new DateTime(2024, 12, 8, 22, 7, 35, 500, DateTimeKind.Local).AddTicks(5775)
                        },
                        new
                        {
                            tagId = "25",
                            postId = "2",
                            AddedOn = new DateTime(2024, 12, 8, 22, 7, 35, 500, DateTimeKind.Local).AddTicks(5820)
                        });
                });
